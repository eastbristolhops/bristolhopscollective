...
let news =[
    ...
    "<b style='color: red'>*** EVEN BIGGER NEWS ***</b> Earlier in the year we said a fond farewell to Dawkins Ales, as they sadly had to close their doors for \
    the last time. However, we are please to announce <a href='https://www.newbristolbrewery.co.uk' target='_blank'>New Bristol Brewery</a> as the official \
     brewer of the 2023 Bristol Hops Collective brew.","  <img class='pumpimage indexpumpimage' src='../static/media/newbristol.png' alt='pumpclip image'>"
]
let events =[
     "The Legendary Cropathon/weigh-in @ New Bristol Brewery Tap Room, 20A Wilson St, St Paul's, Bristol BS2 9HH",
     'Launch party same location as above dates are',
